...
public class ExpoLiveActivities: Module {
	...
	public func definition() -> ModuleDefinition {
		...
		Function("startActivity") {
			(
				key: String, timerId: String, title: String, startTime: Double, 
				duration: Double, paused: Bool, lastPaused: Double?, widgetUrl: String?
			) throws -> Void in
			try handleActivity(
				action: .start,
				key: key,
	...
	private func handleActivity(
		action: ActivityAction, key: String, timerId: String, title: String,
		startTime: Double, duration: Double, paused: Bool, lastPaused: Double?, widgetUrl: String?
	) throws {
		...
		let attributes = TimerAttributes(key: key)
		let contentState = TimerAttributes.ContentState(
			timerId: timerId, title: title, startTime: startTime,
			duration: duration, paused: paused, lastPaused: lastPaused, widgetUrl: widgetUrl)
